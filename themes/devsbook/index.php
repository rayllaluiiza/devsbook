...
<section class="feed mt-10 content">
    <div class="row">
                ...
                <div class="box-body">
                    <div class="feed-new-editor m-10 row">
                        ...
                        <div class="feed-new-send">
                            <img src="<?= Geral::theme('/assets/images/send.png'); ?>" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="box-body">
                    <div class="feed-item-head row mt-20 m-width-20">
                        <div class="feed-item-head-photo">
                            <a href=""><img src="<?= Geral::theme('/media/avatars/avatar.jpg'); ?>" /></a>
                        </div>
                        ...
                        <div class="feed-item-head-btn">
                            <img src="<?= Geral::theme('/assets/images/more.png'); ?>" />
                        </div>
                    </div>
...
<script type="text/javascript" src="<?= Geral::theme('/assets/js/script.js'); ?>"></script>
<script type="text/javascript" src="<?= Geral::theme('/assets/js/vanillaModal.js'); ?>"></script>